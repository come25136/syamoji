        ...
        webSocket = client.newWebSocket(request, object : okhttp3.WebSocketListener() {
            override fun onOpen(webSocket: WebSocket, response: Response) {
                ...
                fetchNxXml("https://nx-jikkyo.tsukumijima.net/api/v1/channels/xml").subscribeOn(
                    ...
                    sendMessage("[{\"ping\":{\"content\":\"rs:0\"}},{\"ping\":{\"content\":\"ps:0\"}},{\"thread\":{\"version\":\"20061206\",\"thread\":\"${nxChannelInfo.thread.id}\",\"threadkey\":\"\",\"user_id\":\"\",\"res_from\":-100}},{\"ping\":{\"content\":\"pf:0\"}},{\"ping\":{\"content\":\"rf:0\"}}]")
                }
            }
